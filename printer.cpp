...
void print_json(std::shared_ptr<Json_entity> x) {
  ...
  case Data_type::STRING: {
    ...
    print_colorful(temp_str_obj->get_value(), Color::GREEN, spaces_count);
    break;
  }
  case Data_type::NUMBER: {
    ...
    print_colorful(std::to_string(temp_num_obj->get_value()), Color::BLUE,
                   spaces_count);
    break;
  }
  case Data_type::TNULL: {
    // std::cout << "printing null\n";
    print_colorful("null", Color::BLUE, spaces_count);
    break;
  }
